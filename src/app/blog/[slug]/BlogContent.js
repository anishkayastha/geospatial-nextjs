                ...
                <div className='mx-auto max-w-4xl'>
                    ...
                    <div className='max-w-4xl mx-auto mt-20 lg:mt-32'>
                        ...
                        <div className='flex justify-center mt-10'>
                            <Link href="/blog" className='transition-all duration-300 ease-in-out text-[11.5px] tracking-[2px] font-bold uppercase bg-violet-600 py-4 px-5 text-white hover:bg-white hover:text-violet-600 hover:shadow-2xl'>View All Blog Posts</Link>
                        </div>
                    </div>
                </div>

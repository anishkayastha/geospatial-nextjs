...
const teamContent = {
    heading: {
        ...
        description:
            "At Geospatial Systems, we're dedicated to shaping environments that transcend mere coordinates, weaving stories and experiences into every geospatial design.",
    },
    ...
    return (
        <section className={`{className}`}>
            <div className="container px-4 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 lg:w-10/12 mx-auto mb-20">

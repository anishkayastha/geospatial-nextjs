                        ...
                        <form className="p-14 bg-white h-full">
                            ...
                            <div className="flex space-x-5">
                                <div className="w-6/12 mb-6">
                                    ...
                                    <input
                                        type="text"
                                        className="rounded-0 appearance-none !text-base p-2 outline-1mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-violet-600 focus:ring-violet-600 block w-full sm:text-sm focus:ring-1 outline-gray-300"
                                        id="firstname"
                                    />
                                </div>
                                <div className="w-6/12 mb-6">
                            ...
                            <div className="block mb-6">
                                ...
                                <textarea
                                    ...
                                    cols="30"
                                    rows="7"
                                    className="rounded-0 appearance-none !text-base p-2 outline-1mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-violet-600 focus:ring-violet-600 block w-full sm:text-sm focus:ring-1 outline-gray-300"></textarea>
                            </div>
                            <div className="block mb-6">
                                <input
                                    type="submit"
